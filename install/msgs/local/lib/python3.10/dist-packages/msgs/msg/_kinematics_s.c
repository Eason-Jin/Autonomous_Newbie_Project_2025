...
bool msgs__msg__kinematics__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msgs.msg._kinematics.Kinematics", full_classname_dest, 31) == 0);
  }
  msgs__msg__Kinematics * ros_message = _ros_message;
  {  // position
  ...
  {  // anglular_velocity
    PyObject * field = PyObject_GetAttrString(_pymsg, "anglular_velocity");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->anglular_velocity = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of Kinematics */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msgs.msg._kinematics");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Kinematics");
  ...
  {  // anglular_velocity
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->anglular_velocity);
    {
      int rc = PyObject_SetAttrString(_pymessage, "anglular_velocity", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
